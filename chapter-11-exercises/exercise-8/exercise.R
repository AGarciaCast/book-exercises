...
atLeast5Win2004To2014 <- pulitzer %>% 
  filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>% 
  mutate(circulationInteger = as.integer(substr(Change.in.Daily.Circulation..2004.2013, 1, nchar(Change.in.Daily.Circulation..2004.2013) - 1))) %>% 
  filter(circulationInteger == min(circulationInteger)) %>% 
  select(Newspaper)

atLeast5Win2004To2014
